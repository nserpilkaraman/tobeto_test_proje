...
class TestTestpasswordmatch():
  ...
  def test_testpasswordmatch(self):
    ...
    self.driver.execute_script("window.scrollTo(0,181.60000610351562)")
    self.driver.find_element(By.NAME, "email").send_keys("pair234@gmail.com")
    self.driver.find_element(By.NAME, "password").click()
    self.driver.find_element(By.NAME, "password").send_keys("1234567")
    self.driver.find_element(By.NAME, "passwordAgain").click()
    self.driver.find_element(By.NAME, "passwordAgain").send_keys("7654321")
